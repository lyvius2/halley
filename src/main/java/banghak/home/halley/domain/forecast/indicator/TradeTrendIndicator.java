 ...
 *
 *
 * 이 지표는 방향을 단정하지 않습니다. 요인 하나의 방향을 낼 뿐이고,
 * 종합 판단은 LLM이 합니다(4.5). 임계값은 요인의 방향을 가르는 데만 씁니다.
 *
 * 가장 직접적인 신호라 무게는 항상 HIGH입니다. "이 집이 실제로 얼마에
...
public class TradeTrendIndicator implements PriceIndicator {
     ...
     *
     * 작은 단지가 늘 판단 보류였습니다. 345세대 단지의 한 평형은 1년에
     * 8건쯤 팔립니다 — 3개월 창에 3건은 채우기 어렵습니다. 그렇다고 표본 기준을
     * 낮추면 2건짜리 중앙값을 추세라 부르게 되어의 취지가 무너집니다.
     *
     * 기준을 낮추는 대신 기간을 늘립니다. "표본이 얇으니 더 긴 기간을
    ...
    /**
     * @param threshold 이만큼 넘게 움직여야 방향을 준다. 임의의 값입니다 —
     *                  부동산 월간 변동의 잡음이 대략 이 정도라 잡았을 뿐이라
     *                  `regulation_param`으로 조절합니다
     */
     ...
     * 표본이 차는 가장 좁은 창을 고른다.
     *
     * 좁을수록 최근을 잘 비춥니다. 3개월로 되면 굳이 넓히지 않습니다.
     */
