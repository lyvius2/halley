 ...
 * 5년 전고점 대비 지금 어디쯤인가.
 *
 * 실거래 추세(I130)와 보는 것이 다릅니다. 그쪽은 최근 3개월이 직전 3개월보다
 * 올랐나를 보는 모멘텀이고, 여기는 5년 안에서 지금이 높은 자리인가를 보는
 * 위치입니다.
 *
 * 둘은 자주 어긋납니다. 고점 근처에서 오르는 중일 수 있습니다 —
 * 그때 추세는 UP, 위치는 DOWN을 냅니다. 그 어긋남을 지우지 않습니다.
 * 저울질은 LLM이 합니다(2.2). 요인을 하나로 합치면 그 재료가 사라집니다.
 *
 * 평균회귀를 가정합니다. 고점에 붙어 있으면 더 오를 여력이 적다고 봅니다 —
