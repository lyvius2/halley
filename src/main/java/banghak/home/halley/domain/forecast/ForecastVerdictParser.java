 ...
 *
 * 방향은 LLM이 정하지만, 판단이 아니라 사실의 문제인 것은 코드가 강제합니다.
 */
@Slf4j
public class ForecastVerdictParser {
    ...
    /**
     * @param prompt 무엇을 줬는지 — 지어낸 숫자를 잡는 기준이다
     * @return 읽을 수 없으면 empty. 부분적으로 이상하면 그 부분만 버리고 나머지를 살린다
     */
     ...
     *
     * 이것이 환각을 잡는 실질적인 장치입니다. 프롬프트로 준 숫자 집합을 들고 있다가
     * 출력의 숫자와 대조합니다.
     */
     ...
     * 요약을 유의사항 앞에 둔다.
     *
     * 유의사항이 비면 채웁니다. 비워 두면 사용자는 이 판단이 모든 것을 봤다고 여깁니다.
     */
