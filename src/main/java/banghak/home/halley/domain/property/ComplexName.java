 ...
 * 단지명을 견주는 규칙.
 *
 * 같은 일을 두 곳에서 다르게 하고 있었습니다. 실거래 카드는 괄호와
 * 그 안의 내용을 통째로 지웠고, 가격 전망은 괄호 기호만 지웠습니다.
 *
 *
 * 국토부  상계주공7(고층)
...
public final class ComplexName {
     ...
     * 견줄 수 있는 꼴로.
     *
     * @return 너무 짧거나 비었으면 null — 이름으로 가릴 수 없다는 뜻이다
     */
     ...
     * 같은 단지로 볼 것인가.
     *
     * 서로 포함이면 같게 봅니다 — `래미안` 과 `래미안아파트`,
     * `상계주공7단지` 와 `상계주공7` 은 같은 곳입니다.
     *
     * @return 둘 중 하나라도 이름을 못 가리면 false. 부르는 쪽이
