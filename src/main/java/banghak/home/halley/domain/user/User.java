 ...
 * 회원.
 *
 * @param groupId 속한 그룹. admin은 null이며 어느 그룹에도 속하지 않고
 *                모든 그룹의 매물을 봅니다
 */
public record User(
        Long id,
         ...
         * 본인이 프로필을 확인했는지.
         *
         * 관리자가 대신 넣은 값은 채워져 있을 뿐입니다. 직장이 어디인지, 현금이
     ...
     * 연소득은 대출 한도(DSR)의 유일한 입력이라 함께 받는다.
    ...
    /** 보유 현금 — `availableBudget`은 예산 상한이자 자기자본이다. */
