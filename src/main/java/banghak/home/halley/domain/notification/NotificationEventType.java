 ...
 * 그룹 채널로 나가는 알림.
 *
 * 모두 한 매물에 딸립니다. 시스템·배치 알림은 두지 않습니다 — 보낼 곳이 없습니다.
...
public enum NotificationEventType {
     ...
     * 알림을 눌렀을 때 열려야 할 곳.
     *
     * `/properties/{id}` 뒤에 붙습니다. 전에는 전부 매물 첫 화면으로 갔습니다 —
     * "누가 쾌적함을 평가했다"는 알림을 눌러도 그 채점 화면까지 다시 찾아
     * 들어가야 했습니다. 모달마다 주소가 생겨(I198) 가능해졌습니다.
     *
     * null 이면 링크를 안 답니다. 삭제 알림이 그렇습니다 — 이미 없는 매물입니다.
     */
