...
public record LoanEstimateInput(
     ...
     *
     * 종류별 입력이 있으면 그것으로, 없으면 옛 단일 금액을 주담대로 보고 계산합니다.
