 ...
 *
 * {@link VirtualThreadGate}와 재는 것이 다릅니다. 그쪽은 동시에 몇 개고,
 * 이쪽은 1초에 몇 개입니다. 동시 실행을 6으로 묶어도 각 호출이 40ms 만에 끝나면
 * 초당 150건이 나갑니다 — 국토부가 실제로 그렇게 돌려줬습니다.
 *
 *
 * LIMITED_NUMBER_OF_SERVICE_REQUESTS_PER_SECOND_EXCEEDS_ERROR
 *
 *
 * 기다리는 쪽을 재우는 게 아니라 자리를 미리 예약합니다. 호출자마다
