...
@Repository
public class CommuteResultJooqRepository implements CommuteResultRepository {

    private final DSLContext dsl;
    private final ObjectMapper objectMapper;

    public CommuteResultJooqRepository(DSLContext dsl, ObjectMapper objectMapper) {
        this.dsl = dsl;
