...
public final class PropertyImageTable {

    private static final String T = "property_image";
    ...
    public static final Field<String> IMAGE_TYPE = field(name(T, "image_type"), String.class);
    public static final Field<String> STORAGE_PATH = field(name(T, "storage_path"), String.class);
    public static final Field<Integer> SORT_ORDER = field(name(T, "sort_order"), Integer.class);

    private PropertyImageTable() {
    }
}
