...
public final class PriceForecastTable {

    private static final String T = "price_forecast";
    ...
    /** LLM 이 스스로 낸 결론. `direction` 은 규칙까지 거친 최종 결론이다 */
    ...
    /** 읽을 때는 타입을 못 박지 않는다 — live는 jsonb, local은 json. */
