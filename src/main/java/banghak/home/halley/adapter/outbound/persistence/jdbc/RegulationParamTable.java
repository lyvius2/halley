...
public final class RegulationParamTable {

    private static final String T = "regulation_param";

    public static final Table<Record> TABLE = table(name(T));

    public static final Field<Long> ID = field(name(T, "id"), Long.class);
    public static final Field<String> PROFILE = field(name(T, "profile"), String.class);
    public static final Field<String> PARAM_KEY = field(name(T, "param_key"), String.class);
    public static final Field<String> PARAM_VALUE = field(name(T, "param_value"), String.class);
