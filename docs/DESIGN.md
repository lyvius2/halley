...
102동과 104동은 <b>좌표가 같습니다.</b> 주소로 찍은 값이라 단지 대표점 하나뿐입니다 —
핀이 정확히 겹쳐 <b>뒤엣것은 누를 수도 없었습니다.</b>

<b>동의 실제 위치를 아는 척하지 않습니다.</b> 우리는 그 좌표를 갖고 있지 않습니다.
겹친 것들을 작은 원(반지름 15m 남짓)으로 <b>벌려 놓을 뿐</b>입니다. 순서는
동·호 이름으로 정합니다 — 정렬을 바꿔도 <b>같은 핀이 같은 자리</b>에 있어야 합니다.
